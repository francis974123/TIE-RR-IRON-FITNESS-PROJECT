...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">RR Iron Fitness</a>
...
<form action="" method="post" class="form-1">
  ...
  <div class="form-group">
    <label for="inputAddress2"><b>Phone number</b></label>
    <input type="Phone number" class="form-control" id="inputAddress2" placeholder="phone number">
  </div>
  
  </div>
  <button type="submit" class="btn btn-primary" style="position:relative;    left: 220px;bottom: -30px;">Sign in</button>
</form>
</div>
